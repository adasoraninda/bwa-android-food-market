...
class SignUpFormValidation @Inject constructor() : FormValidation {
    ...
    companion object {
        ...
        private const val NAME_INVALID_ERROR = "Full name not valid"
    ...
    override fun validateInput(input: Map<String, String?>): Map<String, String?>? {
        fullNameValidation(input[KEY_NAME])?.let { return mapOf(Pair(KEY_NAME, it)) }
    ...
    private fun fullNameValidation(fullName: String?): String? {
